...
public final class Bootstrap {
    ...
    public void init() throws Exception {
        ...
        // 为什么用反射？反射只有两个好处
        // 1.运行时获取类和对象信息，可以进行修改，方法调用，属性赋值
        // 2.new需要具体实现  反射+多态（抽象/接口）进行解耦，简化代码，不需要避免大量if判断
        ...
        // 调用Catalina的 setParentClassLoader（）方法，传入参数 java.lang.ClassLoader
        Method method =
    ...
    private void load(String[] arguments)
        ...
        // 调用catalinaDaemon的 load（）方法，传入参数为空
   ...
   /**
    ...
    public static void main(String args[]) {
        ...
        if (daemon == null) {
            ...
            //deamon是一个指向自己this（当前Bootstripe的对象）的引用
            //里面有catalinaDeamon catalinaLoader等等
            daemon = bootstrap;
        } else {
